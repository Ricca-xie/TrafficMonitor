...
for root, dirs, files in os.walk('C://TrafficMonitor//TrafficMonitor//Result//LONG_GANG//speed_160//baseline//explore_2500_n_steps_500_lr_5e-05_batch_size_350//tensorboard'):
    for file in files:
